...
public class Funds {
    public static List<Fund> getFunds1() {
        ...
        funds.add(new Fund("FO3", "Fundusz Zagraniczny 1", Kind.FOREIGN));
        funds.add(new Fund("FO4", "Fundusz Zagraniczny 2", Kind.FOREIGN));
        funds.add(new Fund("FO5", "Fundusz Zagraniczny 1", Kind.FOREIGN));
        funds.add(new Fund("FO6", "Fundusz Zagraniczny 2", Kind.FOREIGN));
    ...
    public static List<Fund> getFunds2() {
        ...
        funds.add(new Fund("PL1", "Fundusz Polski 1", Kind.POLISH));
        funds.add(new Fund("PL2", "Fundusz Polski 2", Kind.POLISH));
        funds.add(new Fund("PL3", "Fundusz Polski 2", Kind.POLISH));

        funds.add(new Fund("FO1", "Fundusz Zagraniczny 1", Kind.FOREIGN));
        funds.add(new Fund("FO2", "Fundusz Zagraniczny 2", Kind.FOREIGN));
        funds.add(new Fund("FO3", "Fundusz Zagraniczny 2", Kind.FOREIGN));

        funds.add(new Fund("FI1", "Fundusz Pieniężny 1", Kind.FINANCIAL));
        funds.add(new Fund("FI2", "Fundusz Pieniężny 1", Kind.FINANCIAL));
